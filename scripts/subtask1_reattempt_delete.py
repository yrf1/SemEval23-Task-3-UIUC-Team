...
feats_tracker = {}
feats_tracker_save_fpath = "t1_feats_tracker_train.json"
if True: #os.path.exists(feats_tracker_save_fpath):
    with open("t1_feats_tracker.json", "r") as f:
...
#for fname in os.listdir(data_dir+"/"+lang_dir+"/"+task_dir_train):
        ...
        feats_tracker[str(fname)].extend(feats)
